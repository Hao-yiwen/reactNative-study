...
import {Text, Button, ScrollView, Animated, StyleSheet} from 'react-native';
  ...
  return (
    <ScrollView
      ...
      onScroll={Animated.event(
        ...
        {useNativeDriver: false, listener: handleScroll}, // 注意: backgroundColor不支持原生驱动，这里要设为false
      )}
    ...
    >
      <Animated.View style={[styles.content, {backgroundColor}]}>
        <Button
          ...
          onPress={() => {
            console.log('-------分隔符--------');
            navigation.navigate('ScrollviewTest2');
          }}
        />
